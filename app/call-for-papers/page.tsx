  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-4xl px-4 py-10 space-y-8">
        ...
        <div className="space-y-4 rounded-xl p-6 bg-white shadow-lg border border-green-200 animate-fade-in animate-slide-up" style={{ boxShadow: '0 0 24px 4px #38b2ac33, 0 0 8px 2px #2563eb22', transition: 'box-shadow 0.5s' }}>
          <h2 className="text-2xl font-semibold text-green-700">Acknowledgment</h2>
